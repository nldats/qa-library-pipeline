...
![Open Issues](https://img.shields.io/github/issues/nldats/qa-library-pipeline)
![Open PRs](https://img.shields.io/github/issues-pr/nldats/qa-library-pipeline)
![Last Commit](https://img.shields.io/github/last-commit/nldats/qa-library-pipeline)
![CI Pipeline Badge](https://github.com/nldats/qa-library-pipeline/actions/workflows/ci.yml/badge.svg)
...
git clone https://github.com/nldats/qa-library-pipeline.git
cd YOUR_REPO
